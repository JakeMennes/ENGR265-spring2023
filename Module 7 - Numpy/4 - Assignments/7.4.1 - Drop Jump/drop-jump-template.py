...
def main(full_path_to_file):
    ...
    # column 0 row, row equal the length of baseline
    ...
    for index in range(first_landing_index + 10, len(force_plate_list)):
        ...
        ### your code here ###
        value = force_plate_list[index]
        # if the number is longer than baseline + delta than index eqauls the takeoff
        if value < baseline + delta:
    ...
    # note the take_off_index is where the code starts to iterate
    ...
    for index in range(take_off_index + 10, len(force_plate_list)):
        ...
        value = force_plate_list[index]
        if value > baseline + delta:
            # index equals the index when index is more than baseline plus delta
